...
class DesignAdapter(private var data: List<News>, private var presenter: DesignContract.Presenter) :
    RecyclerView.Adapter<DesignAdapter.ThreadViewHolder>() {
